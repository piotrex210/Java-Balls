...
public class MyPanel extends JPanel {
    ...
    public void paint(Graphics graphics){
        ...
        for (int i = 0; i < ballsRadiuses.size(); i++) {
            ...
            g2D.fillOval((int)ballsPositions.get(i)[0]-ballsRadiuses.get(i), (int)ballsPositions.get(i)[1]-ballsRadiuses.get(i), 2*ballsRadiuses.get(i),2*ballsRadiuses.get(i));
        }
    }
}
